...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/construct-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2416&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/construct-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `construct` can be installed with:

```
conda install construct
```

It is possible to list all of the versions of `construct` available on your platform with:
